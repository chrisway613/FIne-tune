...
from utils.dist import get_rank, get_world_size, init_process_group, is_master
...
if __name__ == '__main__':
    ...
    if config.TRAIN.AUTO_RESUME:
        ...
        if resume_file:
            ...
            best_f1, best_em = load_checkpoint(model_wo_ddp, optimizer, lr_scheduler, config, logger)
